...
<body>
	<div class="center">
      <div class="container">
		<h4 class="display-6 fw-bolder text-center mb-5">이용약관</h4>
		<div class="input-form col-md-12 col-lg-12 mx-auto">
			
			<textarea class="form-control mb-4" rows="20">제 1 장 총 칙
제1조 목적
이 약관은 GooPPl 서비스(이하 "서비스"라 합니다)의 이용과 관련하여 현행 법령에 위반하지 않는 범위 내에서 회원의 기본적인 권리와 책임 및 당사와의 중요사항을 정하는 것을 목적으로 합니다.
                    
제2조 용어의 정의
이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
- '서비스'란 '회원'이 이용할 수 있는 GooPPl 및 관련 제반 서비스를 의미합니다.
...
- '회사','서비스제공자'란 ' 주식회사 GooPPl 혹은 주식회사 GooPPl와 계약된 별도서비스 운영자를 뜻합니다.
...
(2) 이 약관은 '서비스제공자'가 GooPPl을 통해 공시함으로서 효력을 발생합니다.
